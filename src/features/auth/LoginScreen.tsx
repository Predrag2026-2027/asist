        ...
        <div style={{ width: '100%', maxWidth: 400 }}>
          ...
          <div style={{ marginBottom: 8 }}>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <button onClick={() => setPrikaziLoz(!prikaziLoz)} style={{ position: 'absolute', right: 6, top: 6, width: 32, height: 32, border: 'none', background: 'none', cursor: 'pointer', color: T.boja.ink400, display: 'flex', alignItems: 'center', justifyContent: 'center' }} aria-label="Prikazi lozinku">
